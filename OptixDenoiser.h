...
OPTIXDENOISER_API OptixResult __cdecl createDenoiser(OptixDeviceContext context, OptixDenoiserModelKind kind, const OptixDenoiserOptions* options, OptixDenoiser* denoiser);
